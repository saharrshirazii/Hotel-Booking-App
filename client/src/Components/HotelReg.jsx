...
export const HotelReg = () => {
  ...
  const { setShowHotelReg } = useAppContext(); //get the setShowHotelReg function from the context to close the hotel registration form
  return (
      ...
      <form className='flex bg-white rounded-xl max-w-4xl max-md:max-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
          ...
          <div className='w-full mt-4'>
            ...
            <input id='name' type="text" placeholder='Type Hotel Name' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
          </div>

          {/* Phone */}
          <div className='w-full mt-4'>
            <label htmlFor="contac" className='font-medium text-gray-500' Hotel Name>Phone</label>
            <input id='contact' type="text" placeholder='Type Phone' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
          </div>

          {/* Address */}
          <div className='w-full mt-4'>
            <label htmlFor="contaddressac" className='font-medium text-gray-500' Hotel Name>Address</label>
            <input id='address' type="text" placeholder='Type Address' className='border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light' required />
          </div>
