...
export const RoomDetails = () => {
  ...
  return room &&(
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {/* Room Raiting */}
      <div className='flex items-center gap01 mt-2'>
        <StarRating/>
      ...
      <div>{roomCommonData.map((spec, index)=>(
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500 '> 
        <p>
          ...
          The price guoted is for two guest, at the guest slot please mark the 
      ...
      <div className='flex flex-col items-start gap-4'>
        <div className='flex gap-4'>
          ...
          <button className='px-6 py-2.5 mt-4 rounded text-white bg-primary hover:bg-primary-dull trasition-all cursor-pointer'>Contact Now</button>
